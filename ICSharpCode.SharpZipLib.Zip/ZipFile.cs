...
namespace ICSharpCode.SharpZipLib.Zip
{
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		public void BeginUpdate(IArchiveStorage archiveStorage, IDynamicDataSource dataSource)
		{
			...
			ZipEntry[] array2 = array;
			foreach (ZipEntry zipEntry in array2)
			{
		...
		public void Add(ZipEntry entry)
		{
			...
			CheckUpdating();
			if (entry.Size != 0L || entry.CompressedSize != 0)
			{
		...
		private Stream GetOutputStream(ZipEntry entry)
		{
			...
			Stream result = compressionMethod switch
			{
		...
		private void ReadEntries()
		{
			...
			for (ulong num10 = 0uL; num10 < num4; num10++)
			{
				...
				zipEntry.Size = num15 & 0xFFFFFFFFu;
				zipEntry.CompressedSize = num14 & 0xFFFFFFFFu;
